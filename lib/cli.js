...
console.log(validateColor('blue'));
console.log(validateColor('random'));
console.log(validateColor('#aaa'));
console.log(validateColor('#aaa0'));
console.log(validateColor('#aaabbb'));
